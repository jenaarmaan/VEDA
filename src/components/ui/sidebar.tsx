  ...
  (
    ...
    return (
      ...
      >
        <div
            data-sidebar="sidebar"
            className={cn("flex h-full flex-col bg-sidebar transition-[width] duration-300 ease-in-out", 
            state === 'expanded' ? 'w-[--sidebar-width]' : 'w-[calc(var(--sidebar-width-icon)+1rem)]'
            )}
          >
            {children}
        </div>
...
>(
  (
    ...
    const tooltipContent = tooltip && typeof tooltip === "string" ? { children: tooltip } : tooltip;
